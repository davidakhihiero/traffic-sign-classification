function [accuracy, confusionMat, precision, recall, f1Score] = TestTrafficSignsSVMSIFT(testPath, img_size)
    ...
    if exist('TrafficSignSVMSIFT.mat', 'file')
        load('TrafficSignSVMSIFT.mat', 'SVMModel');
    else
